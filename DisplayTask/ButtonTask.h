...
private:
    static const uint16_t _debounceMs = 650; // (30-100) are good values
    static const uint16_t _repeatDelayMs = 800; // (400 - 1200) are reasonable values
    static const uint16_t _repeatRateMs = 700; // (40-1000) are reasonable
